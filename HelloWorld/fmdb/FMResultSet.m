...
- (NSDate*)dateForColumnIndex:(int)columnIdx {
    ...
    return [_parentDB hasDateFormatter] ? [_parentDB dateFromString:[self stringForColumnIndex:columnIdx]] : [formatter dateFromString:[self stringForColumnIndex:columnIdx]];
}
